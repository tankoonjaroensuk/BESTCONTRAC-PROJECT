...
<body>
    <div class="container mx-auto">
            ...
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div class="hidden w-full md:block md:w-auto" id="navbar-multi-level">
                    <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                        <li>
                            <a href="#" class="block py-2 px-3 text-gray-900 rounded text-xl hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Home</a>
                        </li>
                        <li>
        ...
        <div class="grid grid-cols-12">
            <div class="col-start-1 col-end-7 bg-blue-100">
                
            </div>
            <div class="col-start-7 col-end-13 bg-blue-200">2</div>
            <div class="col-start-1 col-end-4 bg-blue-700">3</div>
            <div class="col-start-1 col-end-4 bg-blue-700">3</div>
            <div class="col-start-1 col-end-4 bg-blue-700">3</div>
            <div class="col-start-4 col-end-13 row-start-2 row-end-5 bg-blue-200">4</div>
            <div class="col-start-1 col-end-5 bg-blue-950">5</div>
            <div class="col-start-5 col-end-13 bg-blue-800">6</div>
