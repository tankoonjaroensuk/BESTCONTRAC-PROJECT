        ...
        <div class="mt-12 shadow-sm border rounded-lg overflow-x-auto">
            <table class="w-full table-auto text-sm text-left bg-gray-50">
                <thead class=" text-gray-600 font-medium border-b">
                    <tr>
                        <th class="py-3 px-6">payment_id</th>
                        <th class="py-3 px-6">รายการเงิน</th>
                        <th class="py-3 px-6">เลขอ้างอิง</th>
                        <th class="py-3 px-6">รายได้</th> 
                        <th class="py-3 px-6">โดนหักเปอร์เซ็น</th> 
                    </tr>
                </thead>
                <tbody class="text-gray-600 divide-y">
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap">boq_019783</td>
                            <td class="px-6 py-4 whitespace-nowrap">BOQ</td>
                            <td class="px-6 py-4 whitespace-nowrap">THE1975_D82D912_29174</td>
                            <td class="px-6 py-4 whitespace-nowrap">3,710.07</td>
                            <td class="px-6 py-4 whitespace-nowrap">288.93</td>
                        </tr>
                </tbody>
            </table>
        </div>
