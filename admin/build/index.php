    ...
    <aside class="fixed inset-y-0 flex-wrap items-center justify-between block w-full p-0 my-4 overflow-y-auto antialiased transition-transform duration-200 -translate-x-full bg-white border-0 shadow-xl dark:shadow-none dark:bg-slate-850 max-w-64 ease-nav-brand z-990 xl:ml-6 rounded-2xl xl:left-0 xl:translate-x-0" aria-expanded="false">
      <div class="h-19">
        ...
        <a class="block px-8 py-6 m-0 text-sm whitespace-nowrap dark:text-white text-slate-700" href="#" target="_blank">
          <img src="../../image/logoaw.png" class="inline h-full max-w-full transition-all duration-200 dark:hidden ease-nav-brand max-h-8" alt="main_logo" />
          ...
          <span class="ml-1 font-semibold transition-all duration-200 ease-nav-brand">Dashboard Bestcontrac</span>
        </a>
      </div>
            ...
            <ul class="flex flex-row justify-end pl-0 mb-0 list-none md-max:w-full">
              ...
              <li class="flex items-center">
                <a href="../../logout.php" class="block px-0 py-2 text-sm font-semibold text-white transition-all ease-nav-brand">
                  ...
                  <span class="hidden sm:inline"><?php echo $_SESSION['fname']; ?>&nbsp;<?php echo $_SESSION['lname']; ?></span>
                </a>
              </li>
