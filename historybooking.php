                                        ...
                                        ?>
                                            ...
                                            ?>
                                                ...
                                                ?>
                                                    ...
                                                    <a data-update3-id="<?php echo $booking['job_id'] ?>" id="updateProductModal" data-modal-target="updateProductModal" data-modal-toggle="updateProductModal" class="text-white bg-green-700 hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-green-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
                                                        จ้างผู้รับเหมาเลย
                                                    </a>
                                                    <a data-update0-id="<?php echo $booking['job_id'] ?>" id="deleteModal" data-modal-target="deleteModal" data-modal-toggle="deleteModal" class="text-white bg-red-700 hover:bg-red-800 focus:outline-none focus:ring-4 focus:ring-red-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">
                                                        ไม่จ้างต่อ
                                                    </a>
                                                <?php
                                                } else {
                                    ...
                                    <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                                        ...
                                        <div class="flex justify-center items-center space-x-4">
                                            ...
                                            <form method="POST" action="">
                                                ...
                                                <input type="hidden" name="id" id="job_id_value" value="<?php echo $booking['job_id']; ?>">
                                ...
                                <div class="relative p-4 w-full max-w-md max-h-full">
                                    ...
                                    <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                                        ...
                                        <div class="flex justify-center items-center space-x-4">
                                            ...
                                            <form method="POST" action="">
                                                <!-- Hidden input to send job_id -->
                                                <input type="hidden" name="id" id="job_id_value_3" value="<?php echo $booking['job_id']; ?>">
...
if (isset($_POST['update_booking0'])) {
    ...
    $sql = "UPDATE booking_list SET b_type = 0 WHERE job_id = $job_id AND b_type = 2";

    if ($conn->query($sql) === TRUE) {
        echo "<script> window.location.href = './historybooking.php' </script>";
    } else {
...
if (isset($_POST['update_booking3'])) {
    ...
    $sql = "UPDATE booking_list SET b_type = 3 WHERE job_id = $job_id AND b_type = 2";
